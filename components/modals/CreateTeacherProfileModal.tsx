...
import { X, UserCircle2, Briefcase, MapPin, CheckCircle2, AlertCircle, Info } from 'lucide-react';
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="rounded-lg border border-blue-100 bg-blue-50/70 p-3 flex items-start gap-3">
            ...
            <div className="min-w-0">
              <p className="text-sm font-medium text-blue-900 truncate max-w-full">{user.name || 'Teacher user'}</p>
