...
export function EditBatchModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            {/* Modal */}
            <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 overflow-hidden max-h-[90vh] flex flex-col">
                {/* Header */}
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5 overflow-y-auto flex-1 min-h-0">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors focus-visible:ring-purple-500 focus-visible:ring-offset-1"
                            disabled={loading}
                        />
                    </div>
