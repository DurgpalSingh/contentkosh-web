...
export default function UsersPage() {
  ...
  const teacherUserPath = (userId: number ) => `${window.location.pathname}/teacher/${String(userId)}`;
  const studentUserPath = (userId: number ) => `${window.location.pathname}/student/${String(userId)}`;
